...
from ..models.relationship import Friend, Member, Stranger
...
class Element(KritorBaseModel, BaseElement):
    """
    指示一个消息中的元素.
    type (str): 元素类型
    """
...
class ForwardNode(KritorBaseModel):
    """表示合并转发中的一个节点"""
...
class DisplayStrategy(KritorBaseModel):
    title: Optional[str] = None
    """卡片顶部标题"""
    brief: Optional[str] = None
    """消息列表预览"""
